...
export function PostingDetailContent({
  ...
  const handleClose = async () => {
    if (!confirm('この募集をクローズしますか？')) return;
    ...
    return (
      <DashboardLayout user={user}>
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-sm text-[#86868B] mb-4">募集が見つかりません</p>
          <Link href="/dashboard/extra-shifts">
            ...
            {hasApplied ? (
              ...
              <form onSubmit={handleApplySubmit}>
                ...
                <Button
                  type="submit"
                  disabled={applying}
                  className="w-full bg-[#34C759] hover:bg-[#30D158] text-white rounded-xl h-11 text-sm font-semibold gap-2"
                >
