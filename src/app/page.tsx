...
const demoUsers: DemoUser[] = [
  ...
  { key: 'manager1', name: '山田太郎', role: '店長', store: '寝屋川A店' },
  { key: 'manager2', name: '佐藤花子', role: '店長', store: '寝屋川B店' },
  { key: 'manager3', name: '鈴木一郎', role: '店長', store: '寝屋川C店' },
  { key: 'staff1', name: '高橋健太', role: 'スタッフ', store: '寝屋川A店' },
];
